...
class TipoEmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tipo_empresa" do
    assert_difference("TipoEmpresa.count") do
      post tipo_empresas_url, params: { tipo_empresa: { descricao: @tipo_empresa.descricao, observacao: @tipo_empresa.observacao } }, as: :json
    end
  ...
  test "should update tipo_empresa" do
    patch tipo_empresa_url(@tipo_empresa), params: { tipo_empresa: { descricao: @tipo_empresa.descricao, observacao: @tipo_empresa.observacao } }, as: :json
    assert_response :success
  end
